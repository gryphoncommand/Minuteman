...
public final class Constants {
  ...
  public static final class SpindexerConstants {
    public static final int kSpindexerMotorID = 13;
    public static final int kPassthroughMotorID = 12;
    ...
    public static final double kSpindexerRPM = 60.0;
    public static final double kSpindexerMotorRPM = kSpindexerRPM * kgearRatio;
  ...
  public static class IntakeConstants {
    ...
    public static final double kIntakeAngle = Units.radiansToRotations(Math.PI/3); 
    public static final double kGearRatio = 25;

    public static final double kArmLengthInches = 15.53;

    // ASSUMES REV THROUGH BORE ENCODER!!!!!
